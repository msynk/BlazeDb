...
internal static class Diagnostics
{
    ...
    public static readonly DiagnosticDescriptor NotPartial = new(
        ...
        "Type '{0}' is marked [Table] and must be declared partial",
        Category,
    ...
    public static readonly DiagnosticDescriptor MissingOrMultipleKey = new(
        "BLZ002",
        "Table type must have exactly one [Key] property",
        "Type '{0}' must have exactly one serializable property marked [Key]",
        Category,
        DiagnosticSeverity.Error,
        isEnabledByDefault: true);
    ...
    public static readonly DiagnosticDescriptor UnsupportedPropertyType = new(
        ...
        "Property '{0}.{1}' has a type BlazeDb cannot serialize ({2}); mark it [Ignore] or change the type",
        Category,
        DiagnosticSeverity.Error,
        isEnabledByDefault: true);
    ...
    public static readonly DiagnosticDescriptor UnsupportedKeyType = new(
        ...
        "Property '{0}.{1}' is marked [Key] but its type is not a supported non-nullable scalar",
        Category,
        DiagnosticSeverity.Error,
        isEnabledByDefault: true);
    ...
    public static readonly DiagnosticDescriptor CompoundIndexNeedsTwoProperties = new(
        ...
        "Compound index '{0}' on type '{1}' must list at least two properties; use [Index] or [OrderedIndex] for a single one",
        Category,
        DiagnosticSeverity.Error,
        isEnabledByDefault: true);
