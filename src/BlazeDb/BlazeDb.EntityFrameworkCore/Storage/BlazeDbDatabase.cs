...
/// </summary>
internal sealed class BlazeDbDatabase : IDatabase
{
    private readonly IBlazeDbTableCache _tables;

    public BlazeDbDatabase(IBlazeDbTableCache tables) => _tables = tables;
        ...
        foreach (var entry in entries)
        {
            ...
            switch (entry.EntityState)
            {
                ...
                case EntityState.Modified:
                    binding.UpdateInPlace(entity, OriginalValueFactory.Create(entry));
                    break;
                case EntityState.Deleted:
                    binding.Delete(entity, OriginalValueFactory.Create(entry));
                    break;
                default:
                    continue;
            }
    ...
    /// nothing here to await. Call <c>Database.FlushAsync</c> for a hard durability point.
    /// </summary>
