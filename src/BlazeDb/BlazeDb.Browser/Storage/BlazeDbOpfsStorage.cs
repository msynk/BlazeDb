...
public sealed class BlazeDbOpfsStorage : IBlazeDbQuotaAwareStorage, IDisposable
{
    ...
    /// </summary>
    public static async ValueTask<BlazeDbOpfsStorage> CreateAsync(string databaseName, string? moduleUrl = null)
    {
    ...
    /// writer instead of creating an empty one. Pair with <see cref="BlazeDbDatabaseOptions.ReadOnly"/>.
    /// </summary>
