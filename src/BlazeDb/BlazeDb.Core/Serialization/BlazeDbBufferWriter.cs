...
/// </summary>
public sealed class BlazeDbBufferWriter
{
    private byte[] _buffer;
    private int _pos;

    public BlazeDbBufferWriter(int initialCapacity = 256)
    {
    ...
    public void WriteTag(int fieldNumber, BlazeDbWireType wireType) =>
